...
import (
	...
	"github.com/asfsadas/contrib/entgql/internal/todopulid/ent/predicate"
...
func (m *TodoMutation) SetCategoryID(id pulid.ID) {
	m.category = &id
}
...
func (m *TodoMutation) CategoryID() (id pulid.ID, exists bool) {
	if m.category != nil {
